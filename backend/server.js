...
const STATE_LAWS = {
  ...
  "Delaware":{"requirement":"Low","difficulty":"Easy","description":"Delaware requires an annual enrollment form filed with the Department of Education by September 30 and an end-of-year attendance report by July 31. No standardized testing, portfolio reviews, or teacher qualifications are required. Families have broad flexibility in how they structure instruction.","withdrawalNotice":"Yes — annual enrollment form","subjectRequirements":"Not specified — 'regular and thorough instruction' required","testingRequirements":"None","portfolioRequirements":"None","moreInfo":"https://hslda.org/legal/delaware"},
  ...
  "Hawaii":{"requirement":"Moderate","difficulty":"Moderate","description":"Hawaii requires a Notice of Intent filed with the local public school principal. Parents must maintain curriculum records and submit standardized test results or alternative assessments at grades 3, 5, 8, and 10, with annual progress reporting in other years. The curriculum must be structured, sequential, and based on educational objectives.","withdrawalNotice":"Yes — Notice of Intent to school principal","subjectRequirements":"Not mandated but curriculum must be structured and sequential","testingRequirements":"Standardized tests at grades 3, 5, 8, 10; annual assessment in other years","portfolioRequirements":"Yes — curriculum records with subjects, hours, materials, and assessments","moreInfo":"https://hslda.org/legal/hawaii"},
